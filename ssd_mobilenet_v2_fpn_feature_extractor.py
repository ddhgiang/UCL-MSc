        ...
        with slim.arg_scope(self._conv_hyperparams_fn()):
          ...
          with tf.variable_scope('fpn', reuse=self._reuse_weights):
            fpn_features = feature_map_generators.fpn_top_down_feature_maps(
              ...
              for key in ['layer_7', 'layer_14',
                          'layer_19']],
              depth=depth_fn(256))
            last_feature_map = fpn_features['top_down_layer_19']
            coarse_features = {}
            ...
            # print(fpn_features)
            test = [fpn_features['top_down_layer_7'],
              fpn_features['top_down_layer_14'],
              fpn_features['top_down_layer_19'],
              coarse_features['bottom_up_Conv2d_20'],
              coarse_features['bottom_up_Conv2d_21']]
            print(test)

    return [fpn_features['top_down_layer_7'],
            fpn_features['top_down_layer_14'],
            fpn_features['top_down_layer_19'],
            coarse_features['bottom_up_Conv2d_20'],
            coarse_features['bottom_up_Conv2d_21'],
